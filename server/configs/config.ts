...
const config = convict({
	...
	db: {
		...
		uri: {
			...
			format: String,
			default:
				'postgres://csawfyipsxdhtt:190fff0a1e6257b8969421546b2f57c52b80d81b219a6f394948d25c0f37cc5a@ec2-107-20-241-234.compute-1.amazonaws.com:5432/d6omdicjjeh8hd',
			env: 'DB_URI'
		},
		port: {
			doc: 'Database port',
