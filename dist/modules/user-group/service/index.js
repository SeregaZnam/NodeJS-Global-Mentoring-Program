...
const GroupRepository_1 = require("../../group/data-access/repository/GroupRepository");
...
let UserGroupService = class UserGroupService {
    ...
    save(userId, groupId, transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            const group = yield this.groupRepository.getById(groupId);
            const user = yield this.userRepository.getById(userId);
            if (!group || !user) {
                throw new errors_1.NotFoundError('Group or User not found');
            }
